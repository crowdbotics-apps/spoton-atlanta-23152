"""spoton_atlanta_23152 URL Configuration
...
admin.site.site_header = "SpotOn Atlanta"
admin.site.site_title = "SpotOn Atlanta Admin Portal"
admin.site.index_title = "SpotOn Atlanta Admin"

# swagger
api_info = openapi.Info(
    title="SpotOn Atlanta API",
    default_version="v1",
    description="API documentation for SpotOn Atlanta App",
)
